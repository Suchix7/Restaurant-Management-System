...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#435644] text-white ">
      ...
      <div className="bg-[#e8a398] flex flex-col items-start p-8 space-y-4">
  {/* Social Icons */}
  ...
  {/* Title */}
  <h2 className="text-xl font-bold text-gray-900">Jigger & Pony</h2>

  {/* Address */}
  <p className="text-sm font-semibold text-gray-900 max-w-lg">
