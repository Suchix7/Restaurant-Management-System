...
const AddEvents = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post("/specials", data, {
  ...
  return (
    <div>
      ...
      <p className="text-slate-600 mb-6">Create new special events</p>
          ...
          <div className="space-y-2">
            ...
            {posterPreview && (
              <img
                src={posterPreview}
                alt="Poster Preview"
                className="mt-2 w-full max-w-xs h-70 object-cover rounded shadow"
              />
            )}
          </div>
          {loading ? (
